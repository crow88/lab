...
(lib.textfield = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.line4 = new cjs.Text("", "14px 'NanumSquare'");
	...
	this.line3 = new cjs.Text("", "14px 'NanumSquare'");
	...
	this.line2 = new cjs.Text("", "14px 'NanumSquare'");
	...
	this.line1 = new cjs.Text("", "14px 'NanumSquare'");
...
(lib.finish_text_container = function(mode,startPosition,loop) {
	...
	// txt2_2line
	this.line2 = new cjs.Text("", "14px 'UhBeeRyuga'", "#F1439A");
	this.line2.name = "line2";
	...
	// txt2_2line
	this.line1 = new cjs.Text("", "14px 'UhBeeRyuga'", "#F1439A");
	this.line1.name = "line1";
