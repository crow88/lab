...
(lib.textfield = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.line4 = new cjs.Text("", "12px 'Arial'");
	...
	this.line3 = new cjs.Text("", "12px 'Arial'");
	...
	this.line2 = new cjs.Text("", "12px 'Arial'");
	...
	this.line1 = new cjs.Text("", "12px 'Arial'");
...
(lib.finish_text_container = function(mode,startPosition,loop) {
	...
	// txt2_2line
	this.line2 = new cjs.Text("", "12px 'MS PGothic'", "#F1439A");
	this.line2.name = "line2";
	...
	// txt2_2line
	this.line1 = new cjs.Text("", "12px 'MS PGothic'", "#F1439A");
	this.line1.name = "line1";
