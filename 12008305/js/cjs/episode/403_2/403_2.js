...
(lib.textfield = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.line4 = new cjs.Text("", "12px 'EliceDigitalBaeum_Regular'");
	...
	this.line3 = new cjs.Text("", "12px 'EliceDigitalBaeum_Regular'");
	...
	this.line2 = new cjs.Text("", "12px 'EliceDigitalBaeum_Regular'");
	...
	this.line1 = new cjs.Text("", "12px 'EliceDigitalBaeum_Regular'");
...
(lib.finish_text_container = function(mode,startPosition,loop) {
	...
	// txt_1line
	this.line1 = new cjs.Text("", "12px 'EliceDigitalBaeum_Bold'", "#F1439A");
	this.line1.name = "line1";
	...
	// txt_1line
	this.line2 = new cjs.Text("", "12px 'EliceDigitalBaeum_Bold'", "#F1439A");
	this.line2.name = "line2";
