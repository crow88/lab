...
$(function() {
    ...
    function t(e) {
        var e, t;
        e = "l" == m.detail_list[c].show_card_type ? +m.detail_list[c].archive.normal ? m.images.l[c] : m.images.l_premium[c] : +m.detail_list[c].archive.premium ? m.images.l_premium[c] : +m.detail_list[c].archive.normal ? m.images.l[c] : "", t = "l" == m.detail_list[c].show_card_type ? m.images.l_nosign[c] : +m.detail_list[c].archive.premium ? m.images.l_nosign_p[c] : +m.detail_list[c].archive.normal ? m.images.l_nosign[c] : "", q.set({
