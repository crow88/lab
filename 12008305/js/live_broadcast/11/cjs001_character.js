...
(lib.c1002_1 = function() {
	this.initialize(img.c1002_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1002_2 = function() {
	this.initialize(img.c1002_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1002_3 = function() {
	this.initialize(img.c1002_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1002_4 = function() {
	this.initialize(img.c1002_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1002_5 = function() {
	this.initialize(img.c1002_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1002_6 = function() {
	this.initialize(img.c1002_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c1002_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c1002_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c1002_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c1002_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c1002_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c1002_6();
...
(lib.mc_eye_close = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AGaEOIi0grIkZh/IjQAMIhrgCIjBgtIgyiZIBaijIBzgeIAtAGIEMBEIAvAnIDEA5IAYgLIFMAiIBmCjIhEDPg");
	mask.setTransform(-2.4,-76.2);
