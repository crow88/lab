...
(lib.c1003_1 = function() {
	this.initialize(img.c1003_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_2 = function() {
	this.initialize(img.c1003_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_3 = function() {
	this.initialize(img.c1003_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_4 = function() {
	this.initialize(img.c1003_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_5 = function() {
	this.initialize(img.c1003_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_6 = function() {
	this.initialize(img.c1003_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_7 = function() {
	this.initialize(img.c1003_7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1003_8 = function() {
	this.initialize(img.c1003_8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c1003_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c1003_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c1003_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c1003_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c1003_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c1003_6();
	this.instance_5.setTransform(-319.9,-279.9);

	this.instance_6 = new lib.c1003_7();
	this.instance_6.setTransform(-319.9,-279.9);

	this.instance_7 = new lib.c1003_8();
	this.instance_7.setTransform(-319.9,-279.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},2).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).wait(1));
...
(lib.mc_eye_close = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(14.5,-72.7);
...
(lib.mc_like = function(mode,startPosition,loop) {
	...
	this.frame_3 = function() {
		...
		console.log(this.temp_num2);
		console.log(this.temp_num1);
...
(lib.cjs001_character_1 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.character_set.faceblink[3] = 0;
		this.character_set.faceblink[4] = 1;
		this.character_set.faceblink[5] = 1;
		this.character_set.faceblink[6] = 1;
