...
// symbols:
(lib.c0002_1 = function() {
	this.initialize(img.c0002_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0002_2 = function() {
	this.initialize(img.c0002_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0002_3 = function() {
	this.initialize(img.c0002_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0002_4 = function() {
	this.initialize(img.c0002_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0002_5 = function() {
	this.initialize(img.c0002_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0002_6 = function() {
	this.initialize(img.c0002_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0003_1 = function() {
	this.initialize(img.c0003_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0003_2 = function() {
	this.initialize(img.c0003_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0003_3 = function() {
	this.initialize(img.c0003_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0003_4 = function() {
	this.initialize(img.c0003_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0003_5 = function() {
	this.initialize(img.c0003_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0003_6 = function() {
	this.initialize(img.c0003_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c0003_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c0003_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c0003_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c0003_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c0003_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c0003_6();
...
(lib.mc_eye_close = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AoMCKIBqjSICnhBICbgoIDLh4IDaAgICfAoIApBiIgtBfIiAA3IkfgKIj2B9IitBxIiOAvg");
...
(lib.cjs001_character_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{wait:1,jump:12,jump_flower:21,jump_double:38,nod:53,nod_double:61,swing_left:74,swing_right:92,out_L:110,out:121,in_L:131});
		...
		this.motion_act = function(num, flg){
			...
			if(flg){
				switch(num){
					...
					case 2:
						//喜
						this.motion_select(3);
						//this.effect_select(7);
						break;
					case 3:
						//困
						this.motion_select(5);
						break;
					case 4:
						//怒拗
						this.motion_select(1);
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(11).call(this.frame_11).wait(9).call(this.frame_20).wait(4).call(this.frame_24).wait(13).call(this.frame_37).wait(14).call(this.frame_51).wait(9).call(this.frame_60).wait(13).call(this.frame_73).wait(18).call(this.frame_91).wait(18).call(this.frame_109).wait(11).call(this.frame_120).wait(10).call(this.frame_130).wait(15).call(this.frame_145).wait(2));

	// wait_effect_l
	this.wait_effect0 = new lib.mc_effect_container0();
	this.wait_effect0.setTransform(0,-326.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.wait_effect0}]}).wait(148));

	// wait_effect_r
	this.wait_effect1 = new lib.mc_effect_container1();
	this.wait_effect1.setTransform(0,-326.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.wait_effect1}]}).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.flower_pink).wait(21).to({_off:false},0).to({_off:true},16).wait(111));

	// character_set
	this.character_set = new lib.character_set();
	this.character_set.setTransform(0,0,1,1,0,0,0,0,240);

	this.timeline.addTween(cjs.Tween.get(this.character_set).wait(12).to({y:6},0).to({y:-9.8},3,cjs.Ease.get(1)).to({y:3},3,cjs.Ease.get(-0.99)).to({y:0},2).wait(1).to({y:6},2,cjs.Ease.get(1)).to({y:-17.8},3,cjs.Ease.get(1)).to({y:3},4,cjs.Ease.get(-0.99)).to({y:0},2).wait(5).wait(1).to({y:7},0).to({y:-9.8},2,cjs.Ease.get(1)).to({y:7},3,cjs.Ease.get(-0.99)).to({y:-9.8},2,cjs.Ease.get(1)).to({y:7},3,cjs.Ease.get(-0.99)).to({y:0},3).wait(2).to({y:10},3,cjs.Ease.get(1)).to({y:0},4,cjs.Ease.get(-0.99)).wait(1).to({y:10},3,cjs.Ease.get(1)).to({y:0},3,cjs.Ease.get(1)).to({y:10},3,cjs.Ease.get(1)).to({y:0},3,cjs.Ease.get(-0.99)).wait(1).to({rotation:-2.8,x:0.3},8,cjs.Ease.get(1)).to({rotation:0,x:0},9,cjs.Ease.get(-0.99)).wait(1).to({rotation:3,x:-0.1},8,cjs.Ease.get(1)).to({rotation:0,x:0},9,cjs.Ease.get(-0.99)).wait(1).to({x:2},2,cjs.Ease.get(1)).to({x:-49.8,alpha:0.012},8,cjs.Ease.get(-0.99)).wait(11).to({x:4,alpha:1},10,cjs.Ease.get(1)).to({x:0},4).wait(3));
