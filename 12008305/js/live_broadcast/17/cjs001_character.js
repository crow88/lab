...
(lib.c1008_1 = function() {
	this.initialize(img.c1008_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1008_2 = function() {
	this.initialize(img.c1008_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1008_3 = function() {
	this.initialize(img.c1008_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1008_4 = function() {
	this.initialize(img.c1008_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1008_5 = function() {
	this.initialize(img.c1008_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);


(lib.c1008_6 = function() {
	this.initialize(img.c1008_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,620);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c1008_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c1008_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c1008_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c1008_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c1008_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c1008_6();
