...
p.nominalBounds = new cjs.Rectangle(-769.9,-5.9,1015,520);


// symbols:
(lib.c0008_1 = function() {
	this.initialize(img.c0008_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0008_2 = function() {
	this.initialize(img.c0008_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0008_3 = function() {
	this.initialize(img.c0008_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0008_4 = function() {
	this.initialize(img.c0008_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0008_5 = function() {
	this.initialize(img.c0008_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0008_6 = function() {
	this.initialize(img.c0008_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c0008_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c0008_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c0008_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c0008_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c0008_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c0008_6();
...
(lib.mc_eye_close = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AocCPIAtiEICKhRIDcAXICqhBICChxIBsg0ICHgSIB4AhIAPDZIibB+IilAeIjDAZIiyBuIhkAqIiqAIg");
	mask.setTransform(-7.3,-98.5);
...
(lib.cjs001_character_1 = function(mode,startPosition,loop) {
			...
			this.flg=flg;
				...
				switch(this.num){
					...
					case 7:
						//out_L
						if(this.flg){
							this.motion_select(90);
						}
						else{
							this.motion_select(91);
						}
						this.face_select(3);
						break;
					case 8:
	...
	this.character_set.setTransform(-619.9,13,1,1,0,0,0,0,240);

	this.timeline.addTween(cjs.Tween.get(this.character_set).wait(1).to({x:-9.8},0).wait(11).to({y:19},0).to({y:3},3,cjs.Ease.get(1)).to({y:16},3,cjs.Ease.get(-0.99)).to({y:13},2).wait(1).to({y:19},2,cjs.Ease.get(1)).to({y:-4.8},3,cjs.Ease.get(1)).to({y:16},4,cjs.Ease.get(-0.99)).to({y:13},2).wait(5).wait(1).to({y:20},0).to({y:3},2,cjs.Ease.get(1)).to({y:20},3,cjs.Ease.get(-0.99)).to({y:3},2,cjs.Ease.get(1)).to({y:20},3,cjs.Ease.get(-0.99)).to({y:13},3).wait(2).to({y:23},3,cjs.Ease.get(1)).to({y:13},4,cjs.Ease.get(-0.99)).wait(1).to({y:23},5,cjs.Ease.get(1)).to({y:13},6,cjs.Ease.get(-0.99)).wait(6).to({y:23},3,cjs.Ease.get(1)).to({y:13},3,cjs.Ease.get(1)).to({y:23},3,cjs.Ease.get(1)).to({y:13},3,cjs.Ease.get(-0.99)).wait(1).to({rotation:-2.8,x:-9.5,y:12.9},8,cjs.Ease.get(1)).to({rotation:0,x:-9.8,y:13},9,cjs.Ease.get(-0.99)).wait(1).to({rotation:3,x:-10.1},8,cjs.Ease.get(1)).to({rotation:0,x:-9.8},9,cjs.Ease.get(-0.99)).wait(1).to({x:-7.8},2,cjs.Ease.get(1)).to({x:-59.8,alpha:0.012},8,cjs.Ease.get(-0.99)).wait(11).to({x:-5.8,alpha:1},10,cjs.Ease.get(1)).to({x:-9.8},4).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-939.9,-506.9,1015,520);
