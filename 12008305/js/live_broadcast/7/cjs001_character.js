...
// symbols:
(lib.c0007_1 = function() {
	this.initialize(img.c0007_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0007_2 = function() {
	this.initialize(img.c0007_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0007_3 = function() {
	this.initialize(img.c0007_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0007_4 = function() {
	this.initialize(img.c0007_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0007_5 = function() {
	this.initialize(img.c0007_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0007_6 = function() {
	this.initialize(img.c0007_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0007_7 = function() {
	this.initialize(img.c0007_7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c0007_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c0007_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c0007_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c0007_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c0007_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c0007_6();
	this.instance_5.setTransform(-319.9,-279.9);

	this.instance_6 = new lib.c0007_7();
...
(lib.mc_eye_close = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AmlDSIhaiNIA6h9IB3hQIDEgFIDfgcIBpg5ICRAAICHBBIAqBuIgqCCIhxArIisgIIi1gEIiOA7IiRA6g");
	mask.setTransform(-7.2,-95.9);
...
(lib.cjs001_character_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.character_set).wait(12).to({y:6},0).to({y:-9.8},3,cjs.Ease.get(1)).to({y:3},3,cjs.Ease.get(-0.99)).to({y:0},2).wait(1).to({y:6},2,cjs.Ease.get(1)).to({y:-17.8},3,cjs.Ease.get(1)).to({y:3},4,cjs.Ease.get(-0.99)).to({y:0},2).wait(5).wait(1).to({y:7},0).to({y:-9.8},2,cjs.Ease.get(1)).to({y:7},3,cjs.Ease.get(-0.99)).to({y:-9.8},2,cjs.Ease.get(1)).to({y:7},3,cjs.Ease.get(-0.99)).to({y:0},3).wait(2).to({y:10},3,cjs.Ease.get(1)).to({y:0},4,cjs.Ease.get(-0.99)).wait(1).to({y:10},5,cjs.Ease.get(1)).to({y:0},6,cjs.Ease.get(-0.99)).wait(6).to({y:10},3,cjs.Ease.get(1)).to({y:0},3,cjs.Ease.get(1)).to({y:10},3,cjs.Ease.get(1)).to({y:0},3,cjs.Ease.get(-0.99)).wait(1).to({rotation:-2.8,x:0.3},8,cjs.Ease.get(1)).to({rotation:0,x:0},9,cjs.Ease.get(-0.99)).wait(1).to({rotation:3,x:-0.1},8,cjs.Ease.get(1)).to({rotation:0,x:0},9,cjs.Ease.get(-0.99)).wait(1).to({x:2},2,cjs.Ease.get(1)).to({x:-49.8,alpha:0.012},8,cjs.Ease.get(-0.99)).wait(11).to({x:4,alpha:1},10,cjs.Ease.get(1)).to({x:0},4).wait(3));
