...
// symbols:
(lib.c0005_1 = function() {
	this.initialize(img.c0005_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0005_2 = function() {
	this.initialize(img.c0005_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0005_3 = function() {
	this.initialize(img.c0005_3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0005_4 = function() {
	this.initialize(img.c0005_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0005_5 = function() {
	this.initialize(img.c0005_5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);


(lib.c0005_6 = function() {
	this.initialize(img.c0005_6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,640,520);
...
(lib.character_core = function(mode,startPosition,loop) {
	...
	// ch
	this.instance = new lib.c0005_1();
	this.instance.setTransform(-319.9,-279.9);

	this.instance_1 = new lib.c0005_2();
	this.instance_1.setTransform(-319.9,-279.9);

	this.instance_2 = new lib.c0005_3();
	this.instance_2.setTransform(-319.9,-279.9);

	this.instance_3 = new lib.c0005_4();
	this.instance_3.setTransform(-319.9,-279.9);

	this.instance_4 = new lib.c0005_5();
	this.instance_4.setTransform(-319.9,-279.9);

	this.instance_5 = new lib.c0005_6();
...
(lib.mc_eye_close = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AF1DkIjKhcIibhiIiwgZIjZg3IhVgrIgmhQICvhXIEgAbIBGBBIBnB2ICbgUICHA/IA0BXIAXCCIgoAjg");
	mask.setTransform(1.9,-85.8);
